...
## 2025-02-18 - Input Field "Liveness"
**Learning:** Custom text inputs in Pygame without a blinking cursor feel unresponsive/inactive to users accustomed to OS-native inputs.
**Action:** Implement a timer-based blinking cursor (toggling every 500ms) for all text input components to provide immediate visual confirmation of focus and activity.
