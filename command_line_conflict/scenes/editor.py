...
class EditorScene:
    ...
    def __init__(self, game):
        ...
        # Security enhancement: Use user data directory for custom maps
        self.custom_maps_dir = get_user_data_dir() / "maps" / "custom"
        self.custom_maps_dir.mkdir(parents=True, exist_ok=True)
        self.map_path = str(self.custom_maps_dir / "custom_map.json")
    ...
    def open_save_dialog(self):
        ...
        initial_dir = str(self.custom_maps_dir)
