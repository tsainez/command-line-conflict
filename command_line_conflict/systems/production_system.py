...
class ProductionSystem:
    ...
    def update(self, game_state, dt):
        ...
        # Optimization: Instead of looping over all units and all factories (O(N*M)),
        # we iterate over the factories and look up units at the factory's position (O(M)).
        for factory_id, factory_components in factory_entities:
            ...
            # Iterate over a copy to avoid iteration errors if entities are deleted
